/*******************************************************************************
LIGHT DX
Standard light node governed by Trenchbroom key / value pairs.
*******************************************************************************/
#include <godot_cpp/classes/omni_light3d.hpp>

// Needed for cameras that don't exist on layer 1 (eg: wepview cam on the Player)
#define LIGHT_LAYER_MASK 31

class LightDx : public OmniLight3D {
    GDCLASS(LightDx, OmniLight3D)
protected:
...
public:
    ...
    ~LightDx();
    // Properties
    static String get_light_style_pattern(int style_id);
